...
export default function Header({ 
  ...
  return (
    <header className="h-16 bg-slate-900/80 backdrop-blur-xl border-b border-slate-800 px-6 flex items-center justify-between z-20 gap-4">
      {/* Brand Title */}
      ...
      <div className="flex items-center gap-4 shrink-0">
        <div className="hidden lg:flex items-center gap-3 bg-slate-950/60 border border-slate-800/80 px-3.5 py-1.5 rounded-full text-xs">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-slate-400">Active Trace:</span>
